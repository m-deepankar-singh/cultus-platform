-- Migration: Add calculate_client_usage_metrics database function
-- Purpose: Create a function to calculate client-specific analytics including
-- Monthly Active Learners (MAL) per client and Average Product Progress per client.
...
AS $$
WITH
  -- 1. Identify active students in the last 30 days
  active_students AS (
