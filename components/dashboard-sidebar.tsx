    ...
    submenu: [
      {
        ...
        href: "/question-banks?type=course",
        icon: BookOpen,
        role: ["admin", "staff"],
      },
      {
        title: "Assessment Questions",
        href: "/question-banks?type=assessment",
        icon: FileQuestion,
        role: ["admin", "staff"],
      },
    ],
...
export function DashboardSidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div className={cn("hidden border-r bg-background md:block", isOpen ? "w-64" : "w-16")}>{SidebarContent}</div>
