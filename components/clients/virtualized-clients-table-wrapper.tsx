...
import { VirtualizedClientsTable } from "./virtualized-clients-table"

// Server Component to manage the virtualized clients table
export async function VirtualizedClientsTableWrapper() {
  // No initial data fetching needed - the virtualized table will handle everything via TanStack Query
  return <VirtualizedClientsTable />
}

// Placeholder component for loading state
export function VirtualizedClientsTableSkeleton() {
  return (
